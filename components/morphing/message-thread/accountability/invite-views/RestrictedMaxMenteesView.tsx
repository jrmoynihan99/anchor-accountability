// components/morphing/message-thread/accountability/invite-views/RestrictedMaxMenteesView.tsx
import { ThemedText } from "@/components/ThemedText";
import { IconSymbol } from "@/components/ui/IconSymbol";
import React from "react";
import { ScrollView, StyleSheet, TouchableOpacity, View } from "react-native";

interface RestrictedMaxMenteesViewProps {
  colors: any;
  otherUserId: string;
  threadName: string;
  onClose: () => void;
...
export function RestrictedMaxMenteesView({
  colors,
  otherUserId,
  threadName,
  onClose,
}: RestrictedMaxMenteesViewProps) {
  return (
    <ScrollView
