...
import { InfoButton } from "../../morphing/message-thread/info/InfoButton";
import { ThreadInfoModal } from "../../morphing/message-thread/info/InfoModal";
  ...
  return (
    <View style={styles.headerContainer}>
      {Platform.OS === "android" ? (
        ...
        // -----------------------------------------------------
        <View
          style={[styles.blurContainer, { backgroundColor: colors.background }]}
        >
          {renderHeaderContent()}
        </View>
      ) : (
        // -----------------------------------------------------
        // iOS — keep BlurView exactly the same
        // -----------------------------------------------------
        <BlurView
          intensity={50}
